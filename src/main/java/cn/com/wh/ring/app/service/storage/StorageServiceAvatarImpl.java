...
/**
 * Created by Hui on 2017/9/26.
 */

@Service("StorageServiceAvatarImpl")
public class StorageServiceAvatarImpl implements StorageService {
    ...
    @Override
    public void init() {
        this.rootLocation = Paths.get(UPLOAD_AVATAR_LOCATION);
        try {
